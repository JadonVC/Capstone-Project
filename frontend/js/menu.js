        ...
        <div class="menu-item">
            ...
            <div class="item-controls">
                <div class="quantity-selector">
                    <label>Qty:</label>
                    <input type="number" min="1" max="10" value="1" class="qty-input" id="qty-${
                      item.id
                    }">
                </div>
...
async function placeOrder() {
  ...
  try {
    ...
    if (response.success) {
      ...
      alert(
        `Thank you ${name}! Your order #${orderId} for $${cart
          .getTotal()
          .toFixed(
            2
          )} has been placed. We'll contact you at ${phone} with updates.`
      );
